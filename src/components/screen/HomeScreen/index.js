...
class HomeScreen extends BaseScreen {
  constructor(props) {
    ...
    this.sunCircleCenterX = (widthDevice - LEFT_PADDING_SCREEN - RIGHT_PADDING_SCREEN) / 2;
  ...
  getCirclePointY = (x) => {
    return -Math.sqrt(Math.pow(this.sunCircleR, 2) - Math.pow(x - this.sunCircleCenterX, 2)) + this.sunCircleCenterY;
  }
